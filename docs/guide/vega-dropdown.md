...
| `hide-if-empty`       | `boolean`                                                                       | `false`                            | If no options are available, the dropdown list is hidden.                                                                                                                                                                                                                             |
| `scrollbar-color`     | `string`                                                                        | `'var(--vega-border-color)'`       | Scrollbar color.                                                                                                                                                                                                                                                                      |
| `auto-position`       | `boolean`                                                                       | `false`                            | Place the dropdown at the bottom if there is enough space. Otherwise, place it at top of the trigger element. **NOTE**: To calculate dropdown height uses height of single dropdown item. To achieve precise result u may need pass `item-height` prop with actual item height in px. |
| `item-height`         | `nunber`                                                                        | `34`                               | Single dropdown item actual height.                                                                                                                                                                                                                                                   |
| `item-selected-color` | `string`                                                                        | `var(--vega-primary)`              | Dropdown selected item color.                                                                                                                                                                                                                                                         |
| `close-on-select`     | `boolean`                                                                       | `true`                             | Close dropdown on option selected.                                                                                                                                                                                                                                                    |
