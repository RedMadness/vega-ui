...
| `search-placeholder-color` | `string`                            | `'var(--vega-text-color)'`         | Search placeholder icon and text color                                                  |
| `search-placeholder-text`  | `string`                            | `'Search...'`                      | Search placeholder text                                                                 |
