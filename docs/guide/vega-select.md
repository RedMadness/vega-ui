...
| `background-color-cropdown`    | `string`                                                                        | `'transparent'`                    | Background color of the dropdown.                                                                                                                                                                                                                                                     |
...
| `dropdown-auto-position`       | `boolean`                                                                       | `false`                            | Place the dropdown at the bottom if there is enough space. Otherwise, place it at top of the trigger element. **NOTE**: To calculate dropdown height uses height of single dropdown item. To achieve precise result u may need pass `item-height` prop with actual item height in px. |
